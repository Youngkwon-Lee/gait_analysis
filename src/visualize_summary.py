...
def plot_auc_comparison():
    ...
    print(f"✅ AUC 비교 그래프 저장: {save_path}")
    plt.close()
...
def plot_balanced_acc_comparison():
    ...
    plt.savefig(save_path, dpi=300, bbox_inches='tight')
    print(f"✅ Balanced Accuracy 비교 그래프 저장: {save_path}")
    plt.close()
...
def plot_sensitivity_specificity():
    ...
    plt.savefig(save_path, dpi=300, bbox_inches='tight')
    print(f"✅ Sensitivity/Specificity 그래프 저장: {save_path}")
    plt.close()
...
def create_summary_table():
    ...
    print(f"✅ 성능 요약표 저장: {save_path}")


def main():
    print("=" * 60)
    print("성능 비교 시각화 (RESULTS_SUMMARY.md 기반)")
    print("=" * 60)
    print("")

    print("1. ROC-AUC 비교 그래프 생성 중...")
    plot_auc_comparison()

    print("2. Balanced Accuracy 비교 그래프 생성 중...")
    plot_balanced_acc_comparison()

    print("3. Sensitivity/Specificity 그래프 생성 중...")
    plot_sensitivity_specificity()

    print("4. 개선도 히트맵 생성 중...")
