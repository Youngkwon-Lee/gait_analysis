"""
Quick Baseline Test: Simplified version for faster iteration
"""
...
def load_trial_features(trial_path: Path):
    """Extract handcrafted features from a trial"""
...
def main():
    print("="*60)
    print("Quick Baseline: Random Forest with Handcrafted Features")
    print("="*60)
    ...
    results_df.to_csv(OUTPUT_PATH / 'quick_baseline_results.csv', index=False)
    print(f"\nResults saved to: {OUTPUT_PATH / 'quick_baseline_results.csv'}")
